"""Figma 21:1928 — Single Player 'Choose Your Character'."""
...
from ...session import Character, FlowState
from ..theme import DESIGN_W, THEME
from ..widgets import CharacterStrip, ChoiceButton, ChoiceStyle, FlowPage


class SinglePlayerCharacterPage(FlowPage):
    confirmed = Signal(object)  # Character
    ...
    def __init__(self, flow: FlowState, parent: QWidget | None = None) -> None:
        ...
        self._strip = CharacterStrip("Your Duck", self)
    ...
    def _on_confirm(self) -> None:
        ...
        self.confirmed.emit(self.flow.character_p1)
